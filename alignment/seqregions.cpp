...
template double cmaple::SeqRegions::mergeTwoLowers<2>(std::unique_ptr<SeqRegions>&, const RealNumType, const SeqRegions&, const RealNumType, const std::unique_ptr<Alignment>&, const std::unique_ptr<ModelBase>&, const RealNumType, const bool) const;
template double cmaple::SeqRegions::mergeTwoLowers<4>(std::unique_ptr<SeqRegions>&, const RealNumType, const SeqRegions&, const RealNumType, const std::unique_ptr<Alignment>&, const std::unique_ptr<ModelBase>&, const RealNumType, const bool) const;
template double cmaple::SeqRegions::mergeTwoLowers<20>(std::unique_ptr<SeqRegions>&, const RealNumType, const SeqRegions&, const RealNumType, const std::unique_ptr<Alignment>&, const std::unique_ptr<ModelBase>&, const RealNumType, const bool) const;

template void cmaple::SeqRegions::mergeUpperLower<2>(std::unique_ptr<SeqRegions>&, RealNumType, const SeqRegions&, RealNumType, const std::unique_ptr<Alignment>&, const std::unique_ptr<ModelBase>&, const RealNumType) const;
template void cmaple::SeqRegions::mergeUpperLower<4>(std::unique_ptr<SeqRegions>&, RealNumType, const SeqRegions&, RealNumType, const std::unique_ptr<Alignment>&, const std::unique_ptr<ModelBase>&, const RealNumType) const;
template void cmaple::SeqRegions::mergeUpperLower<20>(std::unique_ptr<SeqRegions>&, RealNumType, const SeqRegions&, RealNumType, const std::unique_ptr<Alignment>&, const std::unique_ptr<ModelBase>&, const RealNumType) const;
...
template double cmaple::SeqRegions::calculateSiteLhContributions<2>(std::vector<RealNumType>&, std::unique_ptr<SeqRegions>&, const RealNumType, const SeqRegions&, const RealNumType, const std::unique_ptr<Alignment>&, const std::unique_ptr<ModelBase>&, const RealNumType) const;
template double cmaple::SeqRegions::calculateSiteLhContributions<4>(std::vector<RealNumType>&, std::unique_ptr<SeqRegions>&, const RealNumType, const SeqRegions&, const RealNumType, const std::unique_ptr<Alignment>&, const std::unique_ptr<ModelBase>&, const RealNumType) const;
template double cmaple::SeqRegions::calculateSiteLhContributions<20>(std::vector<RealNumType>&, std::unique_ptr<SeqRegions>&, const RealNumType, const SeqRegions&, const RealNumType, const std::unique_ptr<Alignment>&, const std::unique_ptr<ModelBase>&, const RealNumType) const;
...
template <const StateType num_states>
void cmaple::merge_O_ORACGT(const SeqRegion& seq1_region, const SeqRegion& seq2_region, const RealNumType total_blength_1, const RealNumType total_blength_2, const PositionType end_pos, const RealNumType threshold_prob, const std::unique_ptr<ModelBase>& model, const std::unique_ptr<Alignment>& aln, SeqRegions& merged_regions)
{
    auto new_lh = std::make_unique<SeqRegion::LHType>(); // = new RealNumType[num_states];
...
template <const StateType num_states>
void cmaple::merge_RACGT_O(const SeqRegion& seq2_region, const RealNumType total_blength_2, const PositionType end_pos, SeqRegion::LHType& new_lh, const RealNumType threshold_prob, const std::unique_ptr<ModelBase>& model, const std::unique_ptr<Alignment>& aln, SeqRegions& merged_regions)
{
...
template <const StateType num_states>
void cmaple::merge_RACGT_RACGT(const SeqRegion& seq2_region, const RealNumType total_blength_2, const PositionType end_pos, SeqRegion::LHType& new_lh, const std::unique_ptr<ModelBase>& model, const std::unique_ptr<Alignment>& aln, SeqRegions& merged_regions)
{
    RealNumType sum_new_lh = 0;
    StateType seq2_state = seq2_region.type;
...
template <const StateType num_states>
bool cmaple::merge_O_O_TwoLowers(const SeqRegion& seq2_region, RealNumType total_blength_2, const PositionType end_pos, const std::unique_ptr<Alignment>& aln, const std::unique_ptr<ModelBase>& model, const RealNumType threshold_prob, RealNumType &log_lh, SeqRegion::LHType& new_lh, std::unique_ptr<SeqRegions>& merged_regions, const bool return_log_lh)
{
...
template <const StateType num_states>
bool cmaple::merge_O_RACGT_TwoLowers(const SeqRegion& seq2_region, RealNumType total_blength_2, const PositionType end_pos, const std::unique_ptr<Alignment>& aln, const std::unique_ptr<ModelBase>& model, const RealNumType threshold_prob, RealNumType &log_lh, SeqRegion::LHType& new_lh, RealNumType& sum_lh, std::unique_ptr<SeqRegions>& merged_regions, const bool return_log_lh)
{
    StateType seq2_state = seq2_region.type;
    if (seq2_state == TYPE_R)
        seq2_state = aln->ref_seq[end_pos];
...
template <const StateType num_states>
bool cmaple::merge_O_ORACGT_TwoLowers(const SeqRegion& seq1_region, const SeqRegion& seq2_region, RealNumType total_blength_1, RealNumType total_blength_2, const PositionType end_pos, const std::unique_ptr<Alignment>& aln, const std::unique_ptr<ModelBase>& model, const RealNumType threshold_prob, RealNumType &log_lh, std::unique_ptr<SeqRegions>& merged_regions, const bool return_log_lh)
{
    auto new_lh = std::make_unique<SeqRegion::LHType>(); // = new RealNumType[num_states];
    RealNumType sum_lh = 0;
...
template <const StateType num_states>
bool cmaple::merge_RACGT_O_TwoLowers(const SeqRegion& seq2_region, RealNumType total_blength_2, const PositionType end_pos, const std::unique_ptr<Alignment>& aln, const std::unique_ptr<ModelBase>& model, const RealNumType threshold_prob, SeqRegion::LHType& new_lh, RealNumType &log_lh, std::unique_ptr<SeqRegions>& merged_regions, const bool return_log_lh)
{
    RealNumType sum_lh = updateMultLHwithMat<num_states>(model->mutation_mat, *(seq2_region.likelihood), new_lh, total_blength_2);
...
template <const StateType num_states>
bool cmaple::merge_RACGT_RACGT_TwoLowers(const SeqRegion& seq2_region, RealNumType total_blength_2, const PositionType end_pos, const std::unique_ptr<Alignment>& aln, const std::unique_ptr<ModelBase>& model, const RealNumType threshold_prob, SeqRegion::LHType& new_lh, RealNumType& sum_lh, RealNumType &log_lh, std::unique_ptr<SeqRegions>& merged_regions, const bool return_log_lh)
{
    StateType seq2_state = seq2_region.type;
    if (seq2_state == TYPE_R)
        seq2_state = aln->ref_seq[end_pos];
...
template <const StateType num_states>
bool cmaple::merge_RACGT_ORACGT_TwoLowers(const SeqRegion& seq1_region, const SeqRegion& seq2_region, RealNumType total_blength_1, RealNumType total_blength_2, const PositionType end_pos, const std::unique_ptr<Alignment>& aln, const std::unique_ptr<ModelBase>& model, const RealNumType threshold_prob, RealNumType &log_lh, std::unique_ptr<SeqRegions>& merged_regions, const bool return_log_lh)
{
    StateType seq1_state = seq1_region.type;
    if (seq1_state == TYPE_R)
        seq1_state = aln->ref_seq[end_pos];
...
template <const StateType num_states>
RealNumType cmaple::SeqRegions::mergeTwoLowers(std::unique_ptr<SeqRegions>& merged_regions, const RealNumType plength1, const SeqRegions& regions2, const RealNumType plength2, const std::unique_ptr<Alignment>& aln, const std::unique_ptr<ModelBase>& model, const RealNumType threshold_prob, const bool return_log_lh) const
{
    // init variables
...
template <const StateType num_states>
bool calSiteLhs_O_O(std::vector<RealNumType>& site_lh_contributions, const SeqRegion& seq2_region, RealNumType total_blength_2, const PositionType end_pos, const std::unique_ptr<Alignment>& aln, const std::unique_ptr<ModelBase>& model, const RealNumType threshold_prob, RealNumType &log_lh, SeqRegion::LHType& new_lh, std::unique_ptr<SeqRegions>& merged_regions)
{
    RealNumType sum_lh = updateMultLHwithMat<num_states>(model->mutation_mat, *seq2_region.likelihood, new_lh, total_blength_2);
...
template <const StateType num_states>
bool calSiteLhs_O_ORACGT(std::vector<RealNumType>& site_lh_contributions, const SeqRegion& seq1_region, const SeqRegion& seq2_region, RealNumType total_blength_1, RealNumType total_blength_2, const PositionType end_pos, const std::unique_ptr<Alignment>& aln, const std::unique_ptr<ModelBase>& model, const RealNumType threshold_prob, RealNumType &log_lh, std::unique_ptr<SeqRegions>& merged_regions)
{
    auto new_lh = std::make_unique<SeqRegion::LHType>(); // = new RealNumType[num_states];
    RealNumType sum_lh = 0;
...
template <const StateType num_states>
bool calSiteLhs_RACGT_O(std::vector<RealNumType>& site_lh_contributions, const SeqRegion& seq2_region, RealNumType total_blength_2, const PositionType end_pos, const std::unique_ptr<Alignment>& aln, const std::unique_ptr<ModelBase>& model, const RealNumType threshold_prob, SeqRegion::LHType& new_lh, RealNumType &log_lh, std::unique_ptr<SeqRegions>& merged_regions)
{
    RealNumType sum_lh = updateMultLHwithMat<num_states>(model->mutation_mat, *(seq2_region.likelihood), new_lh, total_blength_2);
...
template <const StateType num_states>
bool calSiteLhs_RACGT_RACGT(std::vector<RealNumType>& site_lh_contributions, const SeqRegion& seq2_region, RealNumType total_blength_2, const PositionType end_pos, const std::unique_ptr<Alignment>& aln, const std::unique_ptr<ModelBase>& model, const RealNumType threshold_prob, SeqRegion::LHType& new_lh, RealNumType& sum_lh, RealNumType &log_lh, std::unique_ptr<SeqRegions>& merged_regions)
{
    StateType seq2_state = seq2_region.type;
    if (seq2_state == TYPE_R)
        seq2_state = aln->ref_seq[end_pos];
...
template <const StateType num_states>
bool calSiteLhs_RACGT_ORACGT(std::vector<RealNumType>& site_lh_contributions, const SeqRegion& seq1_region, const SeqRegion& seq2_region, RealNumType total_blength_1, RealNumType total_blength_2, const PositionType end_pos, const std::unique_ptr<Alignment>& aln, const std::unique_ptr<ModelBase>& model, const RealNumType threshold_prob, RealNumType &log_lh, std::unique_ptr<SeqRegions>& merged_regions)
{
    StateType seq1_state = seq1_region.type;
    if (seq1_state == TYPE_R)
        seq1_state = aln->ref_seq[end_pos];
...
template <const StateType num_states>
RealNumType cmaple::SeqRegions::calculateSiteLhContributions(std::vector<RealNumType>& site_lh_contributions, std::unique_ptr<SeqRegions>& merged_regions, const RealNumType plength1, const SeqRegions& regions2, const RealNumType plength2, const std::unique_ptr<Alignment>& aln, const std::unique_ptr<ModelBase>& model, const RealNumType threshold_prob) const
{
    // init variables
    RealNumType log_lh = 0;
    PositionType pos = 0;
