...
namespace cmaple
{
    ...
    class Alignment {
    public:
        /*! \brief Constructor from a stream of an alignment in FASTA, PHYLIP, or MAPLE format
         ...
         * @param[in] format Format of the alignment (optional): "", "MAPLE", "PHYLIP", "FASTA"
        ...
        /*! \brief Constructor from an alignment file in FASTA, PHYLIP, or MAPLE format
        ...
        /** \brief Write the alignment to a stream
        ...
        /** \brief Write the alignment to a file
    ...
    private:
         ...
         * @param[in] format Format of the alignment: "", "MAPLE", "PHYLIP", "FASTA"
