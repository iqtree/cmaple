...
\begin{DoxyCompactList}\small\item\em Optimize the branch lengths of the current tree. \end{DoxyCompactList}\item 
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ out}}  & {\em out\+\_\+stream} & the output message stream \\
\hline
\end{DoxyParams}
