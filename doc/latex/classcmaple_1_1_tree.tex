...
, \mbox{\hyperlink{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43a313f6f3990c2b8c7ab3f1f174b9e970e}{EXHAUSTIVE\+\_\+\+TREE\+\_\+\+SEARCH}}
...
void \mbox{\hyperlink{classcmaple_1_1_tree_a15e87b19c2d543d25dfe4ca20871c757}{do\+Placement}} (const int num\+\_\+threads, std\+::ostream \&out\+\_\+stream=std\+::cout)
...
void \mbox{\hyperlink{classcmaple_1_1_tree_a79b0a87ee81aef0c2fe3734a684fc8a6}{do\+Rate\+Estimation}} (std\+::ostream \&out\+\_\+stream=std\+::cout)
\begin{DoxyCompactList}\small\item\em Estimate site-\/specific rates/substition matrices either using EM or simple counting method. This function is currently only supported for (DNA) rate variation models. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{classcmaple_1_1_tree_a4e5ebd549df90b66d1f64942ad955cce}{apply\+SPR}} (const int num\+\_\+threads, const \mbox{\hyperlink{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43}{Tree\+Search\+Type}} tree\+\_\+search\+\_\+type, const bool shallow\+\_\+tree\+\_\+search, const bool compute\+\_\+\+SPRTA, std\+::ostream \&out\+\_\+stream=std\+::cout)
...
void \mbox{\hyperlink{classcmaple_1_1_tree_a8ac6ba7243bfdd3e93a2a793b3b4ca63}{infer}} (const int num\+\_\+threads=1, const \mbox{\hyperlink{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43}{Tree\+Search\+Type}} tree\+\_\+search\+\_\+type=\mbox{\hyperlink{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43ad597e07c0182b56b0bc3d67b8fdaf0c1}{NORMAL\+\_\+\+TREE\+\_\+\+SEARCH}}, const bool shallow\+\_\+tree\+\_\+search=false, const bool compute\+\_\+\+SPRTA=false, std\+::ostream \&out\+\_\+stream=std\+::cout)
\begin{DoxyCompactList}\small\item\em Infer a maximum likelihood tree by executing \doxylink{classcmaple_1_1_tree_a15e87b19c2d543d25dfe4ca20871c757}{do\+Placement()}, \doxylink{classcmaple_1_1_tree_a4e5ebd549df90b66d1f64942ad955cce}{apply\+SPR()}, and \doxylink{classcmaple_1_1_tree_afc947148cb44b753d7799b4df5fa83f8}{optimize\+Branch()} \end{DoxyCompactList}\item 
...
std\+::string \mbox{\hyperlink{classcmaple_1_1_tree_a8793d1bd23d185258a68a01bcc279f4e}{export\+Newick}} (const \mbox{\hyperlink{classcmaple_1_1_tree_a750c5e7c53559fbcc421020bad665376}{Tree\+Type}} tree\+\_\+type=\mbox{\hyperlink{classcmaple_1_1_tree_a750c5e7c53559fbcc421020bad665376aed3efab1c9a9364074e767a772c132da}{BIN\+\_\+\+TREE}}, const bool print\+\_\+internal\+\_\+id=false, const bool show\+\_\+branch\+\_\+supports=true)
\begin{DoxyCompactList}\small\item\em Export the phylogenetic tree to a string in NEWICK format. \end{DoxyCompactList}\item 
std\+::string \mbox{\hyperlink{classcmaple_1_1_tree_a1f8fd8e85e6230227d7c8f5af54f27d9}{export\+Nexus}} (const \mbox{\hyperlink{classcmaple_1_1_tree_a750c5e7c53559fbcc421020bad665376}{Tree\+Type}} tree\+\_\+type=\mbox{\hyperlink{classcmaple_1_1_tree_a750c5e7c53559fbcc421020bad665376aed3efab1c9a9364074e767a772c132da}{BIN\+\_\+\+TREE}}, const bool show\+\_\+branch\+\_\+supports=true, const bool show\+\_\+mutations=false)
\begin{DoxyCompactList}\small\item\em Export the phylogenetic tree to a string in NEXUS format. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\raisebox{\heightof{T}}[0pt][0pt]{\index{EXHAUSTIVE\_TREE\_SEARCH@{EXHAUSTIVE\_TREE\_SEARCH}!cmaple::Tree@{cmaple::Tree}}\index{cmaple::Tree@{cmaple::Tree}!EXHAUSTIVE\_TREE\_SEARCH@{EXHAUSTIVE\_TREE\_SEARCH}}}\Hypertarget{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43a313f6f3990c2b8c7ab3f1f174b9e970e}\label{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43a313f6f3990c2b8c7ab3f1f174b9e970e} 
EXHAUSTIVE\+\_\+\+TREE\+\_\+\+SEARCH&Consider all nodes when seeking SPR moves \\
\hline
...
\hline
\end{DoxyExceptions}
\Hypertarget{classcmaple_1_1_tree_a15e87b19c2d543d25dfe4ca20871c757}\label{classcmaple_1_1_tree_a15e87b19c2d543d25dfe4ca20871c757} 
...
{\footnotesize\ttfamily void cmaple\+::\+Tree\+::do\+Placement (\begin{DoxyParamCaption}\item[{const int}]{num\+\_\+threads,  }\item[{std\+::ostream \&}]{out\+\_\+stream = {\ttfamily std\+:\+:cout} }\end{DoxyParamCaption})}
...
\begin{DoxyParams}[1]{Parameters}
\mbox{\texttt{ in}}  & {\em num\+\_\+threads} & The number of threads \\
\hline
...
\hline
\end{DoxyExceptions}
\Hypertarget{classcmaple_1_1_tree_a79b0a87ee81aef0c2fe3734a684fc8a6}\label{classcmaple_1_1_tree_a79b0a87ee81aef0c2fe3734a684fc8a6} 
\index{cmaple::Tree@{cmaple::Tree}!doRateEstimation@{doRateEstimation}}
\index{doRateEstimation@{doRateEstimation}!cmaple::Tree@{cmaple::Tree}}
\doxysubsubsection{\texorpdfstring{doRateEstimation()}{doRateEstimation()}}
{\footnotesize\ttfamily void cmaple\+::\+Tree\+::do\+Rate\+Estimation (\begin{DoxyParamCaption}\item[{std\+::ostream \&}]{out\+\_\+stream = {\ttfamily std\+:\+:cout} }\end{DoxyParamCaption})}



Estimate site-\/specific rates/substition matrices either using EM or simple counting method. This function is currently only supported for (DNA) rate variation models. 
...
\hline
\end{DoxyExceptions}
\Hypertarget{classcmaple_1_1_tree_a4e5ebd549df90b66d1f64942ad955cce}\label{classcmaple_1_1_tree_a4e5ebd549df90b66d1f64942ad955cce} 
...
{\footnotesize\ttfamily void cmaple\+::\+Tree\+::apply\+SPR (\begin{DoxyParamCaption}\item[{const int}]{num\+\_\+threads,  }\item[{const \mbox{\hyperlink{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43}{Tree\+Search\+Type}}}]{tree\+\_\+search\+\_\+type,  }\item[{const bool}]{shallow\+\_\+tree\+\_\+search,  }\item[{const bool}]{compute\+\_\+\+SPRTA,  }\item[{std\+::ostream \&}]{out\+\_\+stream = {\ttfamily std\+:\+:cout} }\end{DoxyParamCaption})}
...
\hline
\mbox{\texttt{ in}}  & {\em compute\+\_\+\+SPRTA} & TRUE to compute \href{https://www.nature.com/articles/s41586-025-09567-x}{\texttt{ SPRTA}} supports \\
\hline
\mbox{\texttt{ out}}  & {\em out\+\_\+stream} & The output message stream (optional) \\
\hline
\end{DoxyParams}
...
\hline
\end{DoxyExceptions}
\Hypertarget{classcmaple_1_1_tree_a8ac6ba7243bfdd3e93a2a793b3b4ca63}\label{classcmaple_1_1_tree_a8ac6ba7243bfdd3e93a2a793b3b4ca63} 
...
{\footnotesize\ttfamily void cmaple\+::\+Tree\+::infer (\begin{DoxyParamCaption}\item[{const int}]{num\+\_\+threads = {\ttfamily 1},  }\item[{const \mbox{\hyperlink{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43}{Tree\+Search\+Type}}}]{tree\+\_\+search\+\_\+type = {\ttfamily \mbox{\hyperlink{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43ad597e07c0182b56b0bc3d67b8fdaf0c1}{NORMAL\+\_\+\+TREE\+\_\+\+SEARCH}}},  }\item[{const bool}]{shallow\+\_\+tree\+\_\+search = {\ttfamily false},  }\item[{const bool}]{compute\+\_\+\+SPRTA = {\ttfamily false},  }\item[{std\+::ostream \&}]{out\+\_\+stream = {\ttfamily std\+:\+:cout} }\end{DoxyParamCaption})}



Infer a maximum likelihood tree by executing \doxylink{classcmaple_1_1_tree_a15e87b19c2d543d25dfe4ca20871c757}{do\+Placement()}, \doxylink{classcmaple_1_1_tree_a4e5ebd549df90b66d1f64942ad955cce}{apply\+SPR()}, and \doxylink{classcmaple_1_1_tree_afc947148cb44b753d7799b4df5fa83f8}{optimize\+Branch()} 
...
\item If users want to use the input (complete/incomplete) tree as a starting tree to perform placement (for an incomplete tree), then consider SPR moves on all nodes, and optimize branch lengths, they can set tree\+\_\+search\+\_\+type = EXHAUSTIVE
\end{DoxyItemize}
...
\hline
\mbox{\texttt{ in}}  & {\em compute\+\_\+\+SPRTA} & TRUE to compute \href{https://www.nature.com/articles/s41586-025-09567-x}{\texttt{ SPRTA}} supports (optional) \\
\hline
\mbox{\texttt{ out}}  & {\em out\+\_\+stream} & The output message stream (optional) \\
\hline
\end{DoxyParams}
...
\hline
\end{DoxyExceptions}
\Hypertarget{classcmaple_1_1_tree_a8793d1bd23d185258a68a01bcc279f4e}\label{classcmaple_1_1_tree_a8793d1bd23d185258a68a01bcc279f4e} 
...
{\footnotesize\ttfamily std\+::string cmaple\+::\+Tree\+::export\+Newick (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classcmaple_1_1_tree_a750c5e7c53559fbcc421020bad665376}{Tree\+Type}}}]{tree\+\_\+type = {\ttfamily \mbox{\hyperlink{classcmaple_1_1_tree_a750c5e7c53559fbcc421020bad665376aed3efab1c9a9364074e767a772c132da}{BIN\+\_\+\+TREE}}},  }\item[{const bool}]{print\+\_\+internal\+\_\+id = {\ttfamily false},  }\item[{const bool}]{show\+\_\+branch\+\_\+supports = {\ttfamily true} }\end{DoxyParamCaption})}
...
\hline
\mbox{\texttt{ in}}  & {\em print\+\_\+internal\+\_\+id} & TRUE to print the id of internal nodes \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\hline
\end{DoxyExceptions}
\Hypertarget{classcmaple_1_1_tree_a1f8fd8e85e6230227d7c8f5af54f27d9}\label{classcmaple_1_1_tree_a1f8fd8e85e6230227d7c8f5af54f27d9} 
\index{cmaple::Tree@{cmaple::Tree}!exportNexus@{exportNexus}}
\index{exportNexus@{exportNexus}!cmaple::Tree@{cmaple::Tree}}
\doxysubsubsection{\texorpdfstring{exportNexus()}{exportNexus()}}
{\footnotesize\ttfamily std\+::string cmaple\+::\+Tree\+::export\+Nexus (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classcmaple_1_1_tree_a750c5e7c53559fbcc421020bad665376}{Tree\+Type}}}]{tree\+\_\+type = {\ttfamily \mbox{\hyperlink{classcmaple_1_1_tree_a750c5e7c53559fbcc421020bad665376aed3efab1c9a9364074e767a772c132da}{BIN\+\_\+\+TREE}}},  }\item[{const bool}]{show\+\_\+branch\+\_\+supports = {\ttfamily true},  }\item[{const bool}]{show\+\_\+mutations = {\ttfamily false} }\end{DoxyParamCaption})}



Export the phylogenetic tree to a string in NEXUS format. 
...
\mbox{\texttt{ in}}  & {\em show\+\_\+branch\+\_\+supports} & TRUE to output the branch supports (a\+LRT-\/\+SH values) \\
\hline
\mbox{\texttt{ in}}  & {\em show\+\_\+mutations} & TRUE to output estimated mutations along tree \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
A tree string in NEXUS format 
\end{DoxyReturn}
