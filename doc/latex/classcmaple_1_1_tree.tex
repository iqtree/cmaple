...
std\+::string \mbox{\hyperlink{classcmaple_1_1_tree_a22c01b063bb2af96259d873b9c82ad8a}{do\+Placement}} ()
\item 
std\+::string \mbox{\hyperlink{classcmaple_1_1_tree_a27aa5671934d696e91f6e5e4e2ab8608}{apply\+SPR}} (const \mbox{\hyperlink{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43}{Tree\+Search\+Type}} tree\+\_\+search\+\_\+type, const bool shallow\+\_\+tree\+\_\+search)
\item 
std\+::string \mbox{\hyperlink{classcmaple_1_1_tree_abe5ff17922b8b186af5e08dabd4151a0}{optimize\+Branch}} ()
\item 
std\+::string \mbox{\hyperlink{classcmaple_1_1_tree_a488a031a981471acb05dd6cd3dd7ed0c}{auto\+Proceed\+MAPLE}} (const \mbox{\hyperlink{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43}{Tree\+Search\+Type}} tree\+\_\+search\+\_\+type=\mbox{\hyperlink{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43ad597e07c0182b56b0bc3d67b8fdaf0c1}{NORMAL\+\_\+\+TREE\+\_\+\+SEARCH}}, const bool shallow\+\_\+tree\+\_\+search=false)
\begin{DoxyCompactList}\small\item\em Infer a phylogenetic tree by executing \doxylink{classcmaple_1_1_tree_a22c01b063bb2af96259d873b9c82ad8a}{do\+Placement()}, \doxylink{classcmaple_1_1_tree_a27aa5671934d696e91f6e5e4e2ab8608}{apply\+SPR()}, and \doxylink{classcmaple_1_1_tree_abe5ff17922b8b186af5e08dabd4151a0}{optimize\+Branch()} \end{DoxyCompactList}\item 
...
std\+::string \mbox{\hyperlink{classcmaple_1_1_tree_a675f8a9a1704bfd3ed8f70d8c9408ab6}{compute\+Branch\+Support}} (const int num\+\_\+threads=1, const int num\+\_\+replicates=1000, const double epsilon=0.\+1, const bool allow\+\_\+replacing\+\_\+\+ML\+\_\+tree=true)
...
NORMAL\+\_\+\+TREE\+\_\+\+SEARCH&Only consider pruning branches at newly-\/added nodes when seeking SPR moves \\
\hline
...
\begin{DoxyItemize}
\item taxa in the tree (is specified) is not found in the alignment
...
\item the alignment is empty
\item the model is unknown/unsupported
\item the tree (is specified) but in an incorrect format
\end{DoxyItemize}\\
\hline
{\em ios\+::failure} & if the tree file (is specified) is not found \\
\hline
{\em std\+::logic\+\_\+error} & if any of the following situations occur.
\begin{DoxyItemize}
\item taxa in the tree (is specified) is not found in the alignment
...
\begin{DoxyExceptions}{Exceptions}
{\em std\+::invalid\+\_\+argument} & if tree is empty or in an incorrect format \\
\hline
{\em std\+::logic\+\_\+error} & if any of the following situations occur.
\begin{DoxyItemize}
...
{\em std\+::logic\+\_\+error} & if any of the following situations occur.
\begin{DoxyItemize}
\item taxa in the current tree is not found in the new alignment
...
\hline
\end{DoxyExceptions}
\Hypertarget{classcmaple_1_1_tree_a22c01b063bb2af96259d873b9c82ad8a}\label{classcmaple_1_1_tree_a22c01b063bb2af96259d873b9c82ad8a} 
...
{\footnotesize\ttfamily std\+::string cmaple\+::\+Tree\+::do\+Placement (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}
...
a string contains all messages redirected from std\+::cout (for information and debugging purpuses only). To output the tree in NEWICK format, one could call \doxylink{classcmaple_1_1_tree_a8d1492f8a3291bd70af3a879b535f880}{export\+Newick()} later 
\end{DoxyReturn}
...
\hline
\end{DoxyExceptions}
\Hypertarget{classcmaple_1_1_tree_a27aa5671934d696e91f6e5e4e2ab8608}\label{classcmaple_1_1_tree_a27aa5671934d696e91f6e5e4e2ab8608} 
...
{\footnotesize\ttfamily std\+::string cmaple\+::\+Tree\+::apply\+SPR (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43}{Tree\+Search\+Type}}}]{tree\+\_\+search\+\_\+type,  }\item[{const bool}]{shallow\+\_\+tree\+\_\+search }\end{DoxyParamCaption})}
...
\hline
\end{DoxyExceptions}
\Hypertarget{classcmaple_1_1_tree_abe5ff17922b8b186af5e08dabd4151a0}\label{classcmaple_1_1_tree_abe5ff17922b8b186af5e08dabd4151a0} 
...
{\footnotesize\ttfamily std\+::string cmaple\+::\+Tree\+::optimize\+Branch (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})}

Optimize the branch lengths of the current tree \begin{DoxyReturn}{Returns}
a string contains all messages redirected from std\+::cout (for information and debugging purpuses only). To output the tree in NEWICK format, one could call \doxylink{classcmaple_1_1_tree_a8d1492f8a3291bd70af3a879b535f880}{export\+Newick()} later 
\end{DoxyReturn}
...
\hline
\end{DoxyExceptions}
\Hypertarget{classcmaple_1_1_tree_a488a031a981471acb05dd6cd3dd7ed0c}\label{classcmaple_1_1_tree_a488a031a981471acb05dd6cd3dd7ed0c} 
...
{\footnotesize\ttfamily std\+::string cmaple\+::\+Tree\+::auto\+Proceed\+MAPLE (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43}{Tree\+Search\+Type}}}]{tree\+\_\+search\+\_\+type = {\ttfamily \mbox{\hyperlink{classcmaple_1_1_tree_a39bd3bfce400c9222e8b77c584d26d43ad597e07c0182b56b0bc3d67b8fdaf0c1}{NORMAL\+\_\+\+TREE\+\_\+\+SEARCH}}},  }\item[{const bool}]{shallow\+\_\+tree\+\_\+search = {\ttfamily false} }\end{DoxyParamCaption})}



Infer a phylogenetic tree by executing \doxylink{classcmaple_1_1_tree_a22c01b063bb2af96259d873b9c82ad8a}{do\+Placement()}, \doxylink{classcmaple_1_1_tree_a27aa5671934d696e91f6e5e4e2ab8608}{apply\+SPR()}, and \doxylink{classcmaple_1_1_tree_abe5ff17922b8b186af5e08dabd4151a0}{optimize\+Branch()} 
...
\end{DoxyItemize}
\item If users already supplied a complete tree, this function, by default, does neither placment nor tree search, but it optimizes all branch lengths. If users want to keep the branch lengths fixed, they should set fixed\+\_\+blengths = true when initializing the tree (by Tree() constructor);
\item If users want to use the input (complete/incomplete) tree as a starting tree to perform placement (for an incomplete tree), then consider SPR moves on all nodes, and optimize branch lengths, they should set tree\+\_\+search\+\_\+type = MORE\+\_\+\+ACCURATE
\end{DoxyItemize}
...
\hline
\end{DoxyExceptions}
\Hypertarget{classcmaple_1_1_tree_a675f8a9a1704bfd3ed8f70d8c9408ab6}\label{classcmaple_1_1_tree_a675f8a9a1704bfd3ed8f70d8c9408ab6} 
...
{\footnotesize\ttfamily std\+::string cmaple\+::\+Tree\+::compute\+Branch\+Support (\begin{DoxyParamCaption}\item[{const int}]{num\+\_\+threads = {\ttfamily 1},  }\item[{const int}]{num\+\_\+replicates = {\ttfamily 1000},  }\item[{const double}]{epsilon = {\ttfamily 0.1},  }\item[{const bool}]{allow\+\_\+replacing\+\_\+\+ML\+\_\+tree = {\ttfamily true} }\end{DoxyParamCaption})}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
A string contains all messages redirected from std\+::cout (for information and debugging purpuses only). To output the branch supports values, one could call export\+Newick(\+BIN, true) later 
\end{DoxyReturn}
...
{\em std\+::invalid\+\_\+argument} & if any of the following situations occur.
\begin{DoxyItemize}
\item n\+\_\+tree\+\_\+type is unknown
