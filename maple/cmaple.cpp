...
void cmaple::runCMAPLE(cmaple::Params &params)
{
    try
    {
        ...
        Model model(aln.ref_seq.size(), useRateVariationModel, params.rate_variation, params.wt_pseudocount, params.rates_filename, params.rate_variation_max_num_EM_steps, params.fixed_SSM_EM_steps, cmaple::ModelBase::DEFAULT, aln.getSeqType());
...
void cmaple::testing(cmaple::Params& params)
{
   ...
   /* Alignment aln10("test_100.maple");
    ...
    tree.infer(tree_search_type, params.shallow_tree_search);
    ...
    std::cout << tree2.infer(cmaple::Tree::FAST_TREE_SEARCH) << std::endl;
