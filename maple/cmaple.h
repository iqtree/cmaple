...
public:
    ...
    /// KEY APIs
    //////////////////////////////////////////////////////////////////////////////////////////////
    // NHANLT - TODO: allow input alignment as std::istream
    ...
    // NHANLT - TODO: change to read Aln -> actually read it here
    /*! \brief Specify an input alignment file
     *
     * Specify an input alignment in MAPLE, PHYLIP, or FASTA format
     * @param[in] aln_stream Stream of an input alignment
    ...
    // NHANLT - TODO: change setTree; allow fixing branch lengths; return an error if providing tree without blengths but want to fix blengths
    // NHANLT - TODO: support tree without branch lengths
    // Also allow reading from a stream
    ...
    // NHANLT - TODO: output in streams: one for log, one for tree, etc
    ...
    // NHANLT - TODO: generate a set of all possible error codes and their corresponsing error messages; remove "CODE_"
    // NHANLT - TODO: change inferTree
    // NHANLT - TODO: mention 2 cases: with and without an input tree
    // NHANLT - TODO: check input a multifurcating tree
    
    // NHANLT - TODO: don't ouput a tree file
    // NHANLT - TODO: allow users to call this function multiple times
    ...
    // NHANLT - TODO: introduce compute Lh function
    
    // NHANLT - TODO: return an error if there is no tree or incomplete tree
    // NHANLT - TODO: remove force_rerun
    ...
    // NHANLT - TODO: change and merge to writeAlignment(); supporting stream; fix aln_filename as the input alignment -> remove aln_filename
    ...
    // NHANLT - TODO: allow inputs as a dictionary
