...
namespace cmaple
{
    ...
    public:
        ...
        void computeTotalLhAtNode(std::unique_ptr<SeqRegions>& total_lh, PhyloNode& neighbor, const std::unique_ptr<AlignmentBase>& aln, const ModelBase* model, const cmaple::RealNumType threshold_prob, const bool is_root, const cmaple::RealNumType blength = -1);
