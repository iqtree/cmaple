...
namespace cmaple
{
    ...
    public:
        ...
        /*! \brief Get an instance of cmaple::Params, which stores all parameter settings. Users can use that Params instance to change other (minor) settings of CMaple (which are not yet supported via the APIs)
