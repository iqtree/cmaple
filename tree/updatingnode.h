...
namespace cmaple
{
    ...
    class UpdatingNode: public cmaple::TraversingNode {
    private:
        /**
        ...
        /**
         a reference to an updated regions from the direction where we come from (taking into account the removal of the given subtree),
         */
