...
template void cmaple::PhyloNode::computeTotalLhAtNode<2>(std::unique_ptr<SeqRegions>&, PhyloNode&, const std::unique_ptr<Alignment>&, const std::unique_ptr<ModelBase>&, const RealNumType, const bool, const RealNumType);
template void cmaple::PhyloNode::computeTotalLhAtNode<4>(std::unique_ptr<SeqRegions>&, PhyloNode&, const std::unique_ptr<Alignment>&, const std::unique_ptr<ModelBase>&, const RealNumType, const bool, const RealNumType);
template void cmaple::PhyloNode::computeTotalLhAtNode<20>(std::unique_ptr<SeqRegions>&, PhyloNode&, const std::unique_ptr<Alignment>&, const std::unique_ptr<ModelBase>&, const RealNumType, const bool, const RealNumType);
...
void cmaple::PhyloNode::computeTotalLhAtNode(std::unique_ptr<SeqRegions>& total_lh, PhyloNode& neighbor, const std::unique_ptr<Alignment>& aln, const std::unique_ptr<ModelBase>& model, const RealNumType threshold_prob, const bool is_root, const RealNumType blength)
{
    // if node is root
    if (is_root)
