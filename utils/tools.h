...
namespace cmaple
{
    ...
    public:
        ...
        /*! \brief Create an instance Params which stores all program parameters. All of them are initialized with the default values.
         */
         ...
         */
        Params& withRandomSeed(const uint64_t& seed);
         ...
         */
        Params& withThreshProb(const double& thresh_prob);
        
        /*! \brief Specify a factor to compute the minimum branch length (if fixed\_min\_blength is specified, this factor is ignored). Default: 0.2
         ...
         */
        Params& withMinBlengthFactor(const double& min_blength_factor);
         ...
         */
        Params& withMaxBlengthFactor(const double& max_blength_factor);
         ...
         */
        Params& withFixedMinBlength(const double& fixed_min_blength);
         ...
         */
        Params& withMutationUpdatePeriod(const int32_t& mutation_update_period);
         ...
         */
        Params& withNumTreeTraversal(const int32_t& num_tree_traversal);
         ...
         */
        Params& withSPRThresh(const double& SPR_thresh);
         ...
         */
        Params& withStopTreeSearchThresh(const double& stop_search_thresh);
